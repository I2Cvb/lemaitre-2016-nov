"""
This pipeline aimed at creating balanced set using random nearmiss 2
approach.
"""
...
path_store = '/data/prostate/balanced/lemaitre-2016-nov/nearmiss-2'
...
for idx_pat, (data_pat, label_pat) in enumerate(zip(data, label)):
    ...
    # Balanced the set
    nm2 = NearMiss(version=2, verbose=True)

    # Under-sample the data
    data_b, label_b = nm2.fit_transform(data[idx_pat], label[idx_pat])
