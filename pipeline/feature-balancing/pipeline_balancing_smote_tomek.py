"""
This pipeline aimed at creating balanced set using random smote+Tomek
approach.
"""
...
path_store = '/data/prostate/balanced/lemaitre-2016-nov/smote-tomek'
...
for idx_pat, (data_pat, label_pat) in enumerate(zip(data, label)):
    ...
    data_b, label_b = stk.fit_transform(data[idx_pat], label[idx_pat])
