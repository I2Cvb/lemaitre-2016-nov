"""
This pipeline aimed at creating balanced set using random nearmiss 3
approach.
"""
...
path_store = '/data/prostate/balanced/lemaitre-2016-nov/nearmiss-3'
...
for idx_pat, (data_pat, label_pat) in enumerate(zip(data, label)):
    ...
    data_b, label_b = nm3.fit_sample(data[idx_pat], label[idx_pat])
