"""
This pipeline aimed at creating balanced set using random smote+enn
approach.
"""
...
path_store = '/data/prostate/balanced/lemaitre-2016-nov/smote-enn'
...
for idx_pat, (data_pat, label_pat) in enumerate(zip(data, label)):
    ...
    # Balanced the set
    senn = SMOTEENN(verbose=True)

    # Under-sample the data
    data_b, label_b = senn.fit_transform(data[idx_pat], label[idx_pat])
