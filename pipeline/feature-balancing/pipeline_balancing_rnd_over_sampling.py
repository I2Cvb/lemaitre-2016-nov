"""
This pipeline aimed at creating balanced set using random over-sampling
approach.
"""
...
path_store = '/data/prostate/balanced/lemaitre-2016-nov/rnd-over-sampling'
...
for idx_pat, (data_pat, label_pat) in enumerate(zip(data, label)):
    ...
    data_b, label_b = ros.fit_sample(data[idx_pat], label[idx_pat])
