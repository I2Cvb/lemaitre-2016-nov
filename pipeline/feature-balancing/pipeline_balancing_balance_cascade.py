"""
This pipeline aimed at creating balanced set using random balance cascade
approach.
"""
...
path_store = '/data/prostate/balanced/lemaitre-2016-nov/balance-cascade'
...
for idx_pat, (data_pat, label_pat) in enumerate(zip(data, label)):
    ...
    # Balanced the set
    bc = BalanceCascade(verbose=True)

    # Under-sample the data
    data_b, label_b = bc.fit_transform(data[idx_pat], label[idx_pat])
