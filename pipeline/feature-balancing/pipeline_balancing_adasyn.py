"""
This pipeline aimed at creating balanced set using ADASYN
approach.
"""
...
path_store = '/data/prostate/balanced/lemaitre-2016-nov/adasyn'
...
for idx_pat, (data_pat, label_pat) in enumerate(zip(data, label)):
    ...
    data_b, label_b = ada.fit_sample(data[idx_pat], label[idx_pat])
