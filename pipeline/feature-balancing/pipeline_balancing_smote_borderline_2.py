"""
This pipeline aimed at creating balanced set using SMOTE borderline 2
approach.
"""
...
path_store = '/data/prostate/balanced/lemaitre-2016-nov/smote-borderline-2'
...
for idx_pat, (data_pat, label_pat) in enumerate(zip(data, label)):
    ...
    data_b, label_b = sm.fit_sample(data[idx_pat], label[idx_pat])
