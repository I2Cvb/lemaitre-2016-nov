"""
This pipeline aimed at creating balanced set using random nearmiss 1
approach.
"""
...
path_store = '/data/prostate/balanced/lemaitre-2016-nov/nearmiss-1'
...
for idx_pat, (data_pat, label_pat) in enumerate(zip(data, label)):
    ...
    # Balanced the set
    nm1 = NearMiss(version=1, verbose=True)

    # Under-sample the data
    data_b, label_b = nm1.fit_transform(data[idx_pat], label[idx_pat])
