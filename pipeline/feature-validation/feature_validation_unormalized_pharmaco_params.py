...
# Tofts patient AIF
filename_results = [
    os.path.join(path_results, 'brix/results_normalized_ese.pkl'),
    os.path.join(path_results, 'hoffmann/results_normalized_ese.pkl'),
    os.path.join(path_results, 'tofts/results_normalized_ese.pkl'),
    os.path.join(path_results, 'tofts-patient-aif/results_normalized_ese.pkl'),
    os.path.join(path_results, 'pun/results_normalized_ese.pkl'),
    os.path.join(path_results, 'semi/results_normalized_ese.pkl')
    ]
