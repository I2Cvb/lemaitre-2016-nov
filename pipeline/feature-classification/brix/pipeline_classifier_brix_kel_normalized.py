...
path_brix = '/data/prostate/pre-processing/lemaitre-2016-nov/brix-features-normalized'
...
for idx_pat in range(len(id_patient_list)):
    ...
    # Select only the parameter kel
    data.append(np.load(os.path.join(path_brix, filename_brix))[:, 1])
...
path_store = '/data/prostate/results/lemaitre-2016-nov/brix-kel-normalized'
