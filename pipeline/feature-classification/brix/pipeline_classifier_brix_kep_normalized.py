...
for idx_pat in range(len(id_patient_list)):
    ...
    # Select only the parameter kep
    data.append(np.load(os.path.join(path_brix, filename_brix))[:, 2])
...
path_store = '/data/prostate/results/lemaitre-2016-nov/brix-kep-normalized'
