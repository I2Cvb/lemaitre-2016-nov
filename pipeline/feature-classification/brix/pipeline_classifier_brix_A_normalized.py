...
for idx_pat in range(len(id_patient_list)):
    ...
    # Select only the parameter A
    data.append(np.load(os.path.join(path_brix, filename_brix))[:, 0])
...
path_store = '/data/prostate/results/lemaitre-2016-nov/brix-A-normalized'
