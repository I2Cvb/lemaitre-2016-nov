...
path_tofts = '/data/prostate/pre-processing/lemaitre-2016-nov/tofts-features-patient-aif-normalized'
...
for idx_pat in range(len(id_patient_list)):
    ...
    data.append(np.load(os.path.join(path_tofts, filename_tofts))[:, 0])
...
path_store = '/data/prostate/results/lemaitre-2016-nov/tofts-ktrans-patient-aif-normalized'
