...
path_tofts = '/data/prostate/pre-processing/lemaitre-2016-nov/tofts-features-normalized'
...
path_store = '/data/prostate/results/lemaitre-2016-nov/tofts-ktrans-normalized'
