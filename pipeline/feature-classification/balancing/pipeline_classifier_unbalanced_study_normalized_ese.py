...
config = [# {'classifier_str': 'random-forest', 'n_estimators': 100,
          #  'gs_n_jobs': n_jobs, 'class_prior': None,
          #  'balancing_criterion': 'random-under-sampling',
          #  'replacement': True},
          ...
          {'classifier_str': 'random-forest', 'n_estimators': 100,
           'gs_n_jobs': n_jobs, 'class_prior': None,
           'balancing_criterion': 'nearmiss', 'version_nearmiss': 1,
           'size_ngh': 3},
          {'classifier_str': 'random-forest', 'n_estimators': 100,
           'gs_n_jobs': n_jobs, 'class_prior': None,
           'balancing_criterion': 'nearmiss', 'version_nearmiss': 2,
           'size_ngh': 3},
          {'classifier_str': 'random-forest', 'n_estimators': 100,
           'gs_n_jobs': n_jobs, 'class_prior': None,
           'balancing_criterion': 'nearmiss', 'version_nearmiss': 3,
           'size_ngh': 3, 'ver3_samp_ngh': 3},
          {'classifier_str': 'random-forest', 'n_estimators': 100,
           'gs_n_jobs': n_jobs,
           'balancing_criterion': 'cnn', 'size_ngh': 3, 'n_seeds_S':1},
          {'classifier_str': 'random-forest', 'n_estimators': 100,
           'gs_n_jobs': n_jobs,
           'balancing_criterion': 'one-sided-selection', 'size_ngh': 1,
           'n_seeds_S':1},
          {'classifier_str': 'random-forest', 'n_estimators': 100,
           'gs_n_jobs': n_jobs, 'class_prior': None,
...
for idx_c, c in enumerate(config):
    ...
    joblib.dump(result_config,
                os.path.join(path_store,
                             'results_unstd_norm_tmp_{}.pkl'.format(idx_c+3)))


# Save the information
joblib.dump(result_config,
            os.path.join(path_store,
                         'results_unbalanced_study_normalized_ese_nb.pkl'))
