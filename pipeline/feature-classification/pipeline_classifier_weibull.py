"""
This pipeline is used to classify Weibull parameters.
"""
...
path_weibull = '/data/prostate/pre-processing/lemaitre-2016-nov/weibull-features'
...
for idx_pat in range(len(id_patient_list)):
    ...
    filename_weibull = (id_patient_list[idx_pat].lower().replace(' ', '_') +
                      '_weibull.npy')

    # Concatenate the training data
    data.append(np.load(os.path.join(path_weibull, filename_weibull)))
...
path_store = '/data/prostate/results/lemaitre-2016-nov/weibull'
