...
for idx_pat in range(len(id_patient_list)):
    ...
    # Select only the wash-out parameter
    data.append(np.load(os.path.join(path_hoffmann, filename_hoffmann))[:, 1])
...
path_store = '/data/prostate/results/lemaitre-2016-nov/semi-washout'
