"""
This pipeline is used to classify semi-quantitative parameters.
"""
...
path_hoffmann = '/data/prostate/pre-processing/lemaitre-2016-nov/semi-features'
...
for idx_pat in range(len(id_patient_list)):
    ...
    # Select only the relative enhancement parameter
    data.append(np.load(os.path.join(path_hoffmann, filename_hoffmann))[:, 4])
...
path_store = '/data/prostate/results/lemaitre-2016-nov/semi-relenh'
