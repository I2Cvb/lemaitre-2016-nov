...
for idx_pat in range(len(id_patient_list)):
    ...
    # Select only the tau parameter
    data.append(np.load(os.path.join(path_hoffmann, filename_hoffmann))[:, 3])
...
path_store = '/data/prostate/results/lemaitre-2016-nov/semi-tau'
