"""
This pipeline is used to classify enhacement signals have not been normalized.
"""
...
path_store = '/data/prostate/results/lemaitre-2016-nov/unormalised-no-balancing'
if not os.path.exists(path_store):
    os.makedirs(path_store)
joblib.dump(result_config, os.path.join(path_store,
                                        'results_unormalized_ese.pkl'))
