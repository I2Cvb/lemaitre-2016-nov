...
for c in config:
    ...
    for sp in sp_level:
        ...
        for idx_lopo_cv in range(len(id_patient_list)):
            ...
            sp_pca = SparsePCA(n_components=sp, n_jobs=-1)
            training_data_projected = sp_pca.fit_transform(training_data)

            # Project the testing data
            testing_data_projected = sp_pca.transform(testing_data)
...
path_store = '/data/prostate/results/lemaitre-2016-nov/sp_pca'
